...
import io.pudge.auresto.config.audit.AuditEventConverter;
import io.pudge.auresto.domain.PersistentAuditEvent;
...
import static io.pudge.auresto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
